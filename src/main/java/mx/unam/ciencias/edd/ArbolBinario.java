...
public abstract class ArbolBinario<T> implements Coleccion<T> {
    ...
    protected class Vertice implements VerticeArbolBinario<T> {
        ...
        @Override public int altura() {
            if(izquierdo == null && derecho != null) return 1 + derecho.altura();
            if(izquierdo != null && derecho == null) return 1 + izquierdo.altura();
    ...
    @Override public boolean contiene(T elemento) {
        //MEJORAR
        if(raiz == null || elemento == null) return false;
    ...
    private VerticeArbolBinario<T> busca(T elemento, Vertice v){
        ...
        if(v.elemento.equals(elemento)) return raiz;
        
        aux = busca(elemento, v.izquierdo);
    ...
    protected Vertice vertice(VerticeArbolBinario<T> vertice) {
        if(! (vertice instanceof ArbolBinario.Vertice)) throw new ClassCastException("Casting de vertice a un vertice de arbol binario que no es vertice");
